        ...
        <div class="col-md-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#usuarios" role="tab" aria-controls="home" aria-selected="true">Usuarios</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#administradores" role="tab" aria-controls="profile" aria-selected="false">Administradores</a>
                </li>
            </ul>
        </div>
                                ...
                                <form method="POST" action="{{ route('crear-usuario') }}">
                                    ...
                                    @foreach ($categorias as $categoria)
                                        <div class="form-group form-check">
                                            ...
                                            <label class="form-check-label" for="crear_usuarios">{{$categoria->name}}</label>
                                        </div>
                                    @endforeach
